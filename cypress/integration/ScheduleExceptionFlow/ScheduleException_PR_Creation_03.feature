Feature: Purchase Request Creation
    ...
    Scenario: Create PR for Test IT for L1 Approval Budget Exception
        ...
        And I take the screenshot
        And I click on "Submitted for Schedule Exception"
        And I click on "Schedule Exception Rejected [Purchase Request Flow]"
        And I take the screenshot
