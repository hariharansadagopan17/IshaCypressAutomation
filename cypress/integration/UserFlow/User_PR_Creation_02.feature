Feature: Purchase Request Creation
    ...
    Scenario: The user inputs the respective department  associated to him
        ...
        And The element should contain "Test IT"
        #And I should see "Test IT" text displayed
        And I take the screenshot
