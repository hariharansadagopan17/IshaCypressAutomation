Feature: Purchase Request Creation
    ...
    Scenario: Create PR for Test IT for Submitted for Purchase flow
        ...
        And I click on "Add a product" Button
        And I wait for "20" secs
        # And I give the product as "Gel Pen"
        #And I wait for "45" secs
        #And I give the quantity as "2"
        #And I wait for "45" secs
        #And I give the UnitOFMeasurement as "Pkt of 5Units"
        #And I wait for "45" secs
        #And I give the Purpose Code as "Maintain Buildings & Facilities"
