Feature: Purchase Request Creation
    ...
    Scenario: Purpose Code is not selected hence Verify that Error message is getting displayed
        ...
        And I wait for "45" secs
        And I should see "Please select a purpose code." text displayed
