...
Scenario: Create PR for Test IT for L1 BudgetOwner Approval
...
And I click on "PR In L1 Budget Approval" Button
And I wait for "5" secs
And I search for PR
And I click on PR
And I wait for "8" secs
And I click on "L1 Budget Owner Approved [Purchase Request Flow]" Button
And I take the screenshot