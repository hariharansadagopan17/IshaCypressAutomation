...
Scenario: Create PR for Test IT for L1 Panel Approval Budget Exception for removing item
...
And I give the Following input in the Purchase Create page 
 ...
 |IF/BT/2027/21 | L1-L2-panel approval | Test IT           | IF Cottages 20-21 |
And I take the screenshot
...
And I wait for "8" secs
And I click on "Approver Dashboard" Button
And I click on "PR Pending In L1 Panel Approval" Button
And I wait for "5" secs
And I search for PR
And I click on PR
And I wait for "8" secs
And I click on "L1 Panel Approved [Purchase Request Flow]" Button
