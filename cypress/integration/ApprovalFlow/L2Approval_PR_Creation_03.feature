...
Scenario: Create PR for Test IT to change the L2 Approval greater than limit
...
And I enter the PR limit as "600"
...
| Product         |Quantity | UnitOFMeasurement |Purposecode                     |
| Gel Pen         | 10       | Pkt of 5Units     |Maintain Buildings & Facilities |
And I take the screenshot
