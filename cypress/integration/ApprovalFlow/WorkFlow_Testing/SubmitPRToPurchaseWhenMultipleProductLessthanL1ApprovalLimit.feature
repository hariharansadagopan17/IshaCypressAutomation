Feature: Submit PR To Purchase When Multiple Product Less Than L1 Approval Limit Request
    I want to submit a Purchase Request  in Sulaba Website when Multiple Product less than L1 Approval Limit
    ...
    Scenario: To Create and Submit Purchase Request with more than 1 product
