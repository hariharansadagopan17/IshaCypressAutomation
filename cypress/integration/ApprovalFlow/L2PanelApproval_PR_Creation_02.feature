...
Scenario: Create PR for Test IT for L2 Panel Approval Budget Exception
...
And I wait for "8" secs
And I click on "Approver Dashboard" Button
And I click on "PR Pending In L2 Panel Approval" Button
And I wait for "5" secs
And I search for PR
And I click on PR
And I wait for "8" secs
...
And I wait for "8" secs
And I click on "Save" Button
And I click on "L2 Panel Approved [Purchase Request Flow]" Button
