...
Scenario: Create PR for Test IT Department for L2 Approval for removing items
...
And I give the Following input in the 2rd Row of Purchase Product page
 | Product         |Quantity |UnitOFMeasurement | Purposecode                          |
 | Marking Pencil  | 10      |Box of 10Units    | Maintain Buildings & Facilities      |
And I take the screenshot
...
And I do the login for the L1 user by entering username as 'senthilprasad.c@ishafoundation.org' and password as 'isha1234'
And I do the assertions for login Button and login successfully
And I wait for "12" secs
And I click on "dropdown" Bar
And I wait for "8" secs
...
And I wait for "8" secs
And I open the login Page in Sulaba Website
And I do the login for the L2 user by entering username as 'abarajith.sadagopan@ishafoundation.org' and password as '123'
And I do the assertions for login Button and login successfully
And I wait for "8" secs
And I click on "dropdown" Bar
And I wait for "8" secs
...
And I give the rejection reason as "Not required now"
